...
#define rot_Kp 0.6  //0.6 //0.35
#define rot_Ki 0.001  //0.001
#define rot_Kd 1.2  //1.2 // 0.5      //0
...
float spFli = 160;         //170    // ค่า setpoint ที่ยอมให้ลูกบอลอยู่ใกล้หุ่นมากที่สุด อาจเริ่มที่จุดกลางจอ แกน Y
